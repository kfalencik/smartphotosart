    ...
    <div class="container">
      <div class="columns">
        <div class="column is-half-widescreen">
          ...
          <p>To return an item, please email customer service at info@smartgraphicsstudio.com to obtain a Return Merchandise Authorization (RMA) number. After receiving a RMA number, place the item securely in its original packaging and include your proof of purchase, and mail your return to the following address:</p>
