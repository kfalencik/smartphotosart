      ...
      frame: [
        ...
        },
        {
          ...
          technical: [
            {
              label: 'Collection',
              value: 'Gallery contemporary'
            },
            {
              label: 'Composite',
              value: 'Solid wood with wood veneer'
            },
            {
              label: 'Color',
              value: 'White'
      ...
      finish: [
        ...
        },
        {
          ...
          technical: [
            ...
            {
              label: 'Max print size',
              value: '56x120" or 120x56"'
            },
            {
              label: 'Printer',
              value: 'Epson SureColor S80600'
            },
            {
              label: 'Inks',
              value: 'Epson Ultrachrome GSX'
            },
            {
              label: 'Dmax & Color Gamut Level',
              value: 'Excellent'
        ...
        },
        {
          ...
          technical: [
            ...
            {
              label: 'Max print size',
              value: '56x100" or 100x56"'
            },
            {
              label: 'Printer',
              value: 'Epson SureColor S70670'
            },
            {
              label: 'Inks',
              value: 'Epson Ultrachrome GSX'
